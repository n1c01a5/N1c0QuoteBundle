...
class LogQuoteController extends FOSRestController
{
    /**
     * Gets logs.
     *
     ...
     *
     * @Annotations\View(
     *  template = "N1c0QuoteBundle:Quote:getLogs.html.twig",
     *  templateVar="logs"   
     * )
     *
    ...
    public function getLogsAction($id)
    {
        ...
        if ($quote = $this->container->get('n1c0_quote.manager.quote')->findQuoteById($id)) {
            $entity = $em->find('Bundle\QuoteBundle\Entity\Quote', $quote->getId());
        } else {
