                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('tag')->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('book')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('n1c0_quote_book')->end()
                                ->scalarNode('name')->defaultValue('n1c0_quote_book')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ->arrayNode('model')->isRequired()
                            ->children()
                                ...
                                ->scalarNode('book')->isRequired()->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ->arrayNode('manager')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('book')->cannotBeEmpty()->defaultValue('n1c0_quote.manager.book.default')->end()
                            ->end()
                        ->end()
                        ->arrayNode('acl')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('book')->cannotBeEmpty()->defaultValue('n1c0_quote.acl.book.security')->end()
                            ->end()
                        ->end()
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('book')->cannotBeEmpty()->defaultValue('n1c0_quote.form_factory.book.default')->end()
