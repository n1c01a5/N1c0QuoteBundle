                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('housepublishing')->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('tags')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('n1c0_quote_tags')->end()
                                ->scalarNode('name')->defaultValue('n1c0_quote_tags')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ->arrayNode('manager')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('tags')->cannotBeEmpty()->defaultValue('n1c0_quote.manager.tags.default')->end()
                            ->end()
                        ->end()
                        ->arrayNode('acl')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('tags')->cannotBeEmpty()->defaultValue('n1c0_quote.acl.tags.security')->end()
                            ->end()
                        ->end()
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('tags')->cannotBeEmpty()->defaultValue('n1c0_quote.form_factory.tags.default')->end()
